...
if nama == "" then
    ...
    if peran == kesatria
        ...
        print "halo Tabib ${nama} , kamu akan membantu temanmu yang terluka"
    else if peran == penyihir
        print "halo Penyihir ${nama} , ciptakan keajaiban yang membantu kemenanganmu!"
    else 
        print "kayaknya kamu jadi bot aja ya, peran yang kamu pilih ga ada" */
